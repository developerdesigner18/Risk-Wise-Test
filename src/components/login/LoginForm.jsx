    ...
    <div className="user-block customscroll">
      <div className="user-box padding-all-40">
        <div className="user-box-inner">
          <a href="#" className="logo gap-bottom-32">
            Risk Wise
          </a>
          ...
          <div className="gap-top-32">
            ...
            <p className="fs-xxs gap-bottom-20">
              By clicking <strong className="text-black">Sign In</strong> below,
              you agree to our Terms and Conditions and Privacy Policy.
            </p>
            <div className="button-group button-group-left gap-bottom-15">
              <Button icon={"ri-login-circle-line"} className="btn-100 btn-primary gap-right-5">
                Sign In
              </Button>
            </div>
